...
urlpatterns = [
    ...
    url(r'^personalYearbookWeb/$', views.PersonalYearbookView.as_view(), name="personalYearbookWeb"),
    url(r'^personalYearbook/$', views.getPersonalYearbook, name="personalYearbook"),
