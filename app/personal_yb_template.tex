...
\author
{%
\faAngleDoubleRight \hspace{2em}  \VAR{student.oneliner}
\newline \faEnvelope  \hspace{2em} \VAR{student.email}
\newline  \faPhone \hspace{4em} \VAR{student.phone}
\newline \faGraduationCap \hspace{2em}  \VAR{student.department}
\newline  \faSuitcase  \hspace{3em} \VAR{student.future}
}
